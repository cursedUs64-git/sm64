...
// 0x0302A6D8
const Lights1 star_seg3_lights_0302A6D8 =
...
const Gfx star_seg3_dl_0302B7B0[] = {
    gsSPLight(&star_seg3_lights_0302A6D8.l, 1),   gsSPLight(&star_seg3_lights_0302A6D8.a, 2),
    gsSPVertex(star_seg3_vertex_0302B6F0, 12, 0), gsSP2Triangles(0, 1, 2, 0x0, 0, 3, 1, 0x0),
    gsSP2Triangles(2, 1, 4, 0x0, 1, 3, 4, 0x0),   gsSP2Triangles(5, 3, 0, 0x0, 4, 3, 5, 0x0),
    gsSP2Triangles(6, 7, 4, 0x0, 7, 2, 4, 0x0),   gsSP2Triangles(8, 6, 4, 0x0, 9, 4, 10, 0x0),
    gsSP2Triangles(9, 11, 4, 0x0, 4, 5, 10, 0x0), gsSP2Triangles(11, 8, 4, 0x0, 0, 2, 7, 0x0),
    gsSP2Triangles(0, 7, 6, 0x0, 0, 6, 8, 0x0),   gsSP2Triangles(0, 8, 11, 0x0, 0, 11, 9, 0x0),
    gsSP2Triangles(10, 5, 0, 0x0, 10, 0, 9, 0x0), gsSPEndDisplayList(),
};
...
const Gfx star_seg3_dl_0302B870[] = {
    ...
    gsDPLoadTextureBlock(
        star_seg3_texture_0302A6F0, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 64, 0, G_TX_WRAP | G_TX_NOMIRROR,
        G_TX_WRAP | G_TX_NOMIRROR, 5, 6, G_TX_NOLOD,
        G_TX_NOLOD), //! Dimensions loaded as 32x64 despite this texture having only 32x32 dimensions,
                     //! harmless due to environment mapping (G_TEXTURE_GEN & gsSPTexture values)
...
// 0x0302B908
const Lights1 star_seg3_lights_0302B908 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);
