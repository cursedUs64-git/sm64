...
UNUSED const Lights1 mad_piano_lights_unused1 =
    gdSPDefLights1(0x05, 0x04, 0x08, 0x14, 0x13, 0x20, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 mad_piano_lights_unused2 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 mad_piano_lights_unused3 =
    gdSPDefLights1(0x2c, 0x2c, 0x2c, 0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 mad_piano_lights_unused4 =
    gdSPDefLights1(0x30, 0x00, 0x00, 0xc3, 0x00, 0x00, 0x28, 0x28, 0x28);
...
// 0x050086F0
const Lights1 mad_piano_seg5_lights_050086F0 =
    gdSPDefLights1(0x4c, 0x4c, 0x4c, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);
...
const Gfx mad_piano_seg5_dl_05008CB0[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 4, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 5,
...
// 0x05008D40
const Lights1 mad_piano_seg5_lights_05008D40 =
    gdSPDefLights1(0x3d, 0x3d, 0x3d, 0xcc, 0xcc, 0xcc, 0x28, 0x28, 0x28);

// 0x05008D58
const Lights1 mad_piano_seg5_lights_05008D58 =
    gdSPDefLights1(0x4c, 0x4c, 0x4c, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x05008D70
const Lights1 mad_piano_seg5_lights_05008D70 =
    gdSPDefLights1(0x26, 0x26, 0x26, 0x7f, 0x7f, 0x7f, 0x28, 0x28, 0x28);

// 0x05008D88
const Lights1 mad_piano_seg5_lights_05008D88 =
...
const Gfx mad_piano_seg5_dl_05009888[] = {
    gsSPLight(&mad_piano_seg5_lights_05008D88.l, 1),   gsSPLight(&mad_piano_seg5_lights_05008D88.a, 2),
    gsSPVertex(mad_piano_seg5_vertex_050094F0, 10, 0), gsSP2Triangles(0, 1, 2, 0x0, 0, 2, 3, 0x0),
    gsSP2Triangles(2, 4, 3, 0x0, 2, 5, 4, 0x0),        gsSP2Triangles(0, 6, 1, 0x0, 0, 7, 6, 0x0),
    gsSP2Triangles(0, 8, 7, 0x0, 0, 9, 8, 0x0),        gsSPEndDisplayList(),
};
...
const Gfx mad_piano_seg5_dl_050098E8[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 4, G_TX_NOLOD,
