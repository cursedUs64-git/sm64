...
UNUSED const Lights1 king_bobomb_lights_unused1 =
    gdSPDefLights1(0x36, 0x1e, 0x00, 0xd9, 0x7a, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 king_bobomb_lights_unused2 =
    gdSPDefLights1(0x00, 0x00, 0x3f, 0x00, 0x00, 0xff, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 king_bobomb_lights_unused3 =
    gdSPDefLights1(0x3c, 0x28, 0x00, 0xf1, 0xa2, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 king_bobomb_lights_unused4 =
    gdSPDefLights1(0x2c, 0x2c, 0x2c, 0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 king_bobomb_lights_unused5 =
    gdSPDefLights1(0x06, 0x06, 0x06, 0x19, 0x19, 0x19, 0x28, 0x28, 0x28);

// 0x05000078
ALIGNED8 const Texture king_bobomb_seg5_texture_05000078[] = {
...
// 0x05002078
ALIGNED8 const Texture king_bobomb_seg5_texture_05002078[] = {
...
// 0x05005078 - Unused
ALIGNED8 const Texture king_bobomb_seg5_texture_05005078[] = {
#include "actors/king_bobomb/king_bob-omb_eyes_blink.rgba16.inc.c"
};

// 0x05005878
ALIGNED8 const Texture king_bobomb_seg5_texture_05005878[] = {
#include "actors/king_bobomb/king_bob-omb_hand.rgba16.inc.c"
};

// 0x05006078
ALIGNED8 const Texture king_bobomb_seg5_texture_05006078[] = {
#include "actors/king_bobomb/king_bob-omb_crown_rim.rgba16.inc.c"
};

// 0x05006478
ALIGNED8 const Texture king_bobomb_seg5_texture_05006478[] = {
...
// 0x05009478
ALIGNED8 const Texture king_bobomb_seg5_texture_05009478[] = {
#include "actors/king_bobomb/king_bob-omb_right_side.rgba16.inc.c"
};

// 0x0500A478
const Vtx king_bobomb_seg5_vertex_0500A478[] = {
...
// 0x0500A560
const Vtx king_bobomb_seg5_vertex_0500A560[] = {
...
// 0x0500A648
const Vtx king_bobomb_seg5_vertex_0500A648[] = {
...
// 0x0500A818
const Vtx king_bobomb_seg5_vertex_0500A818[] = {
    { { { 26, 26, 0 }, 0, { 990, 0 }, { 0xff, 0xff, 0xff, 0xff } } },
    { { { -25, 26, 0 }, 0, { 0, 0 }, { 0xff, 0xff, 0xff, 0xff } } },
    { { { -25, -25, 0 }, 0, { 0, 990 }, { 0xff, 0xff, 0xff, 0xff } } },
    { { { 26, -25, 0 }, 0, { 990, 990 }, { 0xff, 0xff, 0xff, 0xff } } },
...
// 0x0500A900
const Vtx king_bobomb_seg5_vertex_0500A900[] = {
    { { { 49, 49, 0 }, 0, { 990, 0 }, { 0xff, 0xff, 0xff, 0xff } } },
    { { { -48, 49, 0 }, 0, { 0, 0 }, { 0xff, 0xff, 0xff, 0xff } } },
    { { { -48, -48, 0 }, 0, { 0, 990 }, { 0xff, 0xff, 0xff, 0xff } } },
    { { { 49, -48, 0 }, 0, { 990, 990 }, { 0xff, 0xff, 0xff, 0xff } } },
...
// 0x0500A9E8
const Lights1 king_bobomb_seg5_lights_0500A9E8 =
    gdSPDefLights1(0x6f, 0x56, 0x11, 0xde, 0xad, 0x23, 0x28, 0x28, 0x28);

// 0x0500AA00
const Vtx king_bobomb_seg5_vertex_0500AA00[] = {
...
// 0x0500AB00
const Vtx king_bobomb_seg5_vertex_0500AB00[] = {
    { { { 6, 138, 148 }, 0, { 0, 0 }, { 0xbc, 0x65, 0x22, 0xff } } },
    { { { 6, 138, -31 }, 0, { 0, 0 }, { 0xd6, 0x6e, 0xd3, 0xff } } },
...
// 0x0500AD38
const Lights1 king_bobomb_seg5_lights_0500AD38 =
    gdSPDefLights1(0x6f, 0x4f, 0x10, 0xde, 0x9e, 0x20, 0x28, 0x28, 0x28);

// 0x0500AD50
const Vtx king_bobomb_seg5_vertex_0500AD50[] = {
...
// 0x0500AE50
const Vtx king_bobomb_seg5_vertex_0500AE50[] = {
...
// 0x0500B098
const Vtx king_bobomb_seg5_vertex_0500B098[] = {
...
// 0x0500B0D8
const Vtx king_bobomb_seg5_vertex_0500B0D8[] = {
...
// 0x0500B200
const Lights1 king_bobomb_seg5_lights_0500B200 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x0500B218
const Vtx king_bobomb_seg5_vertex_0500B218[] = {
...
// 0x0500B330
const Lights1 king_bobomb_seg5_lights_0500B330 =
    gdSPDefLights1(0x7f, 0x7f, 0x7f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x0500B348
const Vtx king_bobomb_seg5_vertex_0500B348[] = {
...
// 0x0500B458
const Lights1 king_bobomb_seg5_lights_0500B458 =
    gdSPDefLights1(0x7f, 0x7f, 0x7f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x0500B470
const Vtx king_bobomb_seg5_vertex_0500B470[] = {
...
// 0x0500B570
const Vtx king_bobomb_seg5_vertex_0500B570[] = {
    { { { 729, -304, -175 }, 0, { 2948, -458 }, { 0xee, 0x94, 0xc2, 0xff } } },
