...
UNUSED const Lights1 chuckya_lights_unused1 =
    gdSPDefLights1(0x26, 0x00, 0x27, 0x9a, 0x00, 0x9c, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 chuckya_lights_unused2 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 chuckya_lights_unused3 =
    gdSPDefLights1(0x3f, 0x00, 0x00, 0xff, 0x00, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 chuckya_lights_unused4 =
    gdSPDefLights1(0x0e, 0x0e, 0x0e, 0x39, 0x39, 0x39, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 chuckya_lights_unused5 =
    gdSPDefLights1(0x39, 0x20, 0x00, 0xe4, 0x83, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 chuckya_lights_unused6 =
    gdSPDefLights1(0x3f, 0x27, 0x00, 0xff, 0x9e, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 chuckya_lights_unused7 =
    gdSPDefLights1(0x15, 0x14, 0x16, 0x57, 0x53, 0x58, 0x28, 0x28, 0x28);
...
// 0x0800A668
const Lights1 chuckya_seg8_lights_0800A668 =
...
// 0x0800A7C8
const Lights1 chuckya_seg8_lights_0800A7C8 =
    gdSPDefLights1(0x29, 0x29, 0x29, 0x89, 0x89, 0x8a, 0x28, 0x28, 0x28);
...
const Gfx chuckya_seg8_dl_0800A870[] = {
    gsSPLight(&chuckya_seg8_lights_0800A7C8.l, 1),  gsSPLight(&chuckya_seg8_lights_0800A7C8.a, 2),
    gsSPVertex(chuckya_seg8_vertex_0800A7E0, 9, 0), gsSP2Triangles(0, 1, 2, 0x0, 3, 0, 2, 0x0),
    gsSP2Triangles(1, 4, 2, 0x0, 5, 6, 2, 0x0),     gsSP2Triangles(6, 7, 2, 0x0, 8, 5, 2, 0x0),
    gsSP2Triangles(7, 3, 2, 0x0, 4, 8, 2, 0x0),     gsSPEndDisplayList(),
};
...
// 0x0800A8F0
const Lights1 chuckya_seg8_lights_0800A8F0 =
    gdSPDefLights1(0x4c, 0x4c, 0x00, 0xff, 0xff, 0x00, 0x28, 0x28, 0x28);
...
const Gfx chuckya_seg8_dl_0800A958[] = {
    gsSPLight(&chuckya_seg8_lights_0800A8F0.l, 1),  gsSPLight(&chuckya_seg8_lights_0800A8F0.a, 2),
    gsSPVertex(chuckya_seg8_vertex_0800A908, 5, 0), gsSP2Triangles(0, 1, 2, 0x0, 0, 3, 4, 0x0),
    gsSP2Triangles(0, 2, 3, 0x0, 0, 4, 1, 0x0),     gsSPEndDisplayList(),
};
...
// 0x0800A9B8
const Lights1 chuckya_seg8_lights_0800A9B8 =
    gdSPDefLights1(0x0c, 0x0c, 0x0c, 0x32, 0x32, 0x32, 0x28, 0x28, 0x28);
...
const Gfx chuckya_seg8_dl_0800ABE8[] = {
    gsDPPipeSync(), gsSPClearGeometryMode(G_SHADING_SMOOTH), gsSPDisplayList(chuckya_seg8_dl_0800AB70),
    gsDPPipeSync(), gsSPSetGeometryMode(G_SHADING_SMOOTH),   gsSPEndDisplayList(),
};
