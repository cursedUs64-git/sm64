...
// 0x0500C258
const Lights1 haunted_cage_seg5_lights_0500C258 =
    gdSPDefLights1(0x39, 0x0c, 0x0e, 0x90, 0x1e, 0x25, 0x28, 0x28, 0x28);

// 0x0500C270
const Lights1 haunted_cage_seg5_lights_0500C270 =
...
const Gfx haunted_cage_seg5_dl_0500F7D8[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 4,
...
// 0x0500F888
const Lights1 haunted_cage_seg5_lights_0500F888 =
...
// 0x0500FC98
const Lights1 haunted_cage_seg5_lights_0500FC98 =
