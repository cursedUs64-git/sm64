...
UNUSED const Lights1 spindrift_lights_unused1 =
    gdSPDefLights1(0x3f, 0x08, 0x1b, 0xff, 0x22, 0x6d, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 spindrift_lights_unused2 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xfd, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x05000030
const Lights1 spindrift_seg5_lights_05000030 =
    gdSPDefLights1(0x12, 0x2c, 0x00, 0x49, 0xb2, 0x00, 0x28, 0x28, 0x28);

// 0x05000048
const Lights1 spindrift_seg5_lights_05000048 =
    gdSPDefLights1(0x37, 0x3f, 0x00, 0xdd, 0xff, 0x01, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 spindrift_lights_unused3 =
    gdSPDefLights1(0x00, 0x15, 0x00, 0x00, 0x56, 0x00, 0x28, 0x28, 0x28);

// 0x05000078
const Lights1 spindrift_seg5_lights_05000078 =
    gdSPDefLights1(0x3f, 0x38, 0x00, 0xff, 0xe2, 0x00, 0x28, 0x28, 0x28);

// 0x05000090
const Lights1 spindrift_seg5_lights_05000090 =
    gdSPDefLights1(0x00, 0x0f, 0x00, 0x00, 0x3f, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 spindrift_lights_unused4 =
