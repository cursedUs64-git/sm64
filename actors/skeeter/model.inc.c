...
UNUSED const Lights1 skeeter_lights_unused1 =
    gdSPDefLights1(0x3f, 0x20, 0x02, 0xfc, 0x80, 0x08, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 skeeter_lights_unused2 =
    gdSPDefLights1(0x05, 0x05, 0x02, 0x15, 0x15, 0x08, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 skeeter_lights_unused3 =
    gdSPDefLights1(0x03, 0x10, 0x29, 0x0e, 0x40, 0xa4, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 skeeter_lights_unused4 =
    gdSPDefLights1(0x3b, 0x3a, 0x36, 0xef, 0xea, 0xd9, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 skeeter_lights_unused5 =
    gdSPDefLights1(0x33, 0x0c, 0x00, 0xcf, 0x32, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 skeeter_lights_unused6 =
    gdSPDefLights1(0x10, 0x29, 0x20, 0x42, 0xa5, 0x81, 0x28, 0x28, 0x28);
...
const Gfx skeeter_seg6_dl_06000CA8[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 4, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 3, G_TX_NOLOD,
...
// 0x06000DE8
const Lights1 skeeter_seg6_lights_06000DE8 =
    gdSPDefLights1(0x7f, 0x55, 0x00, 0xff, 0xaa, 0x00, 0x28, 0x28, 0x28);
...
const Gfx skeeter_seg6_dl_06000E60[] = {
    gsSPLight(&skeeter_seg6_lights_06000DE8.l, 1),  gsSPLight(&skeeter_seg6_lights_06000DE8.a, 2),
    gsSPVertex(skeeter_seg6_vertex_06000E00, 6, 0), gsSP2Triangles(0, 1, 2, 0x0, 0, 3, 1, 0x0),
    gsSP2Triangles(2, 1, 4, 0x0, 1, 3, 4, 0x0),     gsSP2Triangles(3, 0, 4, 0x0, 5, 2, 4, 0x0),
    gsSP2Triangles(0, 5, 4, 0x0, 5, 0, 2, 0x0),     gsSPEndDisplayList(),
};
...
const Gfx skeeter_seg6_dl_06003FF0[] = {
    gsSPVertex(skeeter_seg6_vertex_06000EF0, 11, 0), gsSP2Triangles(0, 1, 2, 0x0, 0, 3, 4, 0x0),
    gsSP2Triangles(0, 4, 5, 0x0, 0, 5, 1, 0x0),      gsSP2Triangles(0, 2, 3, 0x0, 6, 7, 8, 0x0),
    gsSP2Triangles(9, 10, 7, 0x0, 6, 9, 7, 0x0),     gsSPEndDisplayList(),
};
...
const Gfx skeeter_seg6_dl_060040A0[] = {
    gsSPVertex(skeeter_seg6_vertex_06001020, 11, 0), gsSP2Triangles(0, 1, 2, 0x0, 0, 3, 4, 0x0),
    gsSP2Triangles(0, 4, 5, 0x0, 0, 5, 1, 0x0),      gsSP2Triangles(0, 2, 3, 0x0, 6, 7, 8, 0x0),
    gsSP2Triangles(9, 10, 7, 0x0, 6, 9, 7, 0x0),     gsSPEndDisplayList(),
};
...
const Gfx skeeter_seg6_dl_06004150[] = {
    gsSPVertex(skeeter_seg6_vertex_06001150, 11, 0), gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 2, 0x0),
    gsSP2Triangles(5, 3, 2, 0x0, 1, 5, 2, 0x0),      gsSP2Triangles(4, 0, 2, 0x0, 6, 7, 8, 0x0),
    gsSP2Triangles(7, 9, 10, 0x0, 7, 10, 8, 0x0),    gsSPEndDisplayList(),
};
...
const Gfx skeeter_seg6_dl_060045C8[] = {
    gsSPVertex(skeeter_seg6_vertex_06001A80, 11, 0), gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 2, 0x0),
    gsSP2Triangles(5, 3, 2, 0x0, 1, 5, 2, 0x0),      gsSP2Triangles(4, 0, 2, 0x0, 6, 7, 8, 0x0),
    gsSP2Triangles(7, 9, 10, 0x0, 7, 10, 8, 0x0),    gsSPEndDisplayList(),
};
