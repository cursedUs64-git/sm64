...
// 0x06003A00
const Lights1 lakitu_seg6_lights_06003A00 =
    gdSPDefLights1(0x7f, 0x7f, 0x7f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x06003A18
const Lights1 lakitu_seg6_lights_06003A18 =
    gdSPDefLights1(0x79, 0x55, 0x00, 0xf2, 0xab, 0x00, 0x28, 0x28, 0x28);
...
const Gfx lakitu_seg6_dl_06003DB0[] = {
    gsSPLight(&lakitu_seg6_lights_06003A18.l, 1),   gsSPLight(&lakitu_seg6_lights_06003A18.a, 2),
    gsSPVertex(lakitu_seg6_vertex_06003BD0, 11, 0), gsSP2Triangles(0, 1, 2, 0x0, 2, 3, 4, 0x0),
    gsSP2Triangles(1, 5, 2, 0x0, 4, 0, 2, 0x0),     gsSP2Triangles(5, 3, 2, 0x0, 4, 6, 0, 0x0),
    gsSP2Triangles(7, 8, 1, 0x0, 9, 7, 0, 0x0),     gsSP2Triangles(1, 0, 7, 0x0, 8, 10, 1, 0x0),
    gsSP2Triangles(1, 10, 5, 0x0, 0, 6, 9, 0x0),    gsSPEndDisplayList(),
};
...
// 0x06003E98
const Lights1 lakitu_seg6_lights_06003E98 =
    gdSPDefLights1(0x7f, 0x7f, 0x7f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);
...
// 0x060046E0
const Lights1 lakitu_seg6_lights_060046E0 =
    gdSPDefLights1(0x79, 0x55, 0x00, 0xf2, 0xab, 0x00, 0x28, 0x28, 0x28);
...
// 0x060048D8
const Lights1 lakitu_seg6_lights_060048D8 =
    gdSPDefLights1(0x79, 0x55, 0x00, 0xf2, 0xab, 0x00, 0x28, 0x28, 0x28);
...
// 0x06004AD0
const Lights1 lakitu_seg6_lights_06004AD0 =
    gdSPDefLights1(0x7f, 0x7f, 0x7f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);
...
const Gfx lakitu_seg6_dl_06004BA8[] = {
    gsSPLight(&lakitu_seg6_lights_06004AD0.l, 1),   gsSPLight(&lakitu_seg6_lights_06004AD0.a, 2),
    gsSPVertex(lakitu_seg6_vertex_06004AE8, 12, 0), gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 5, 0x0),
...
// 0x06004CB0
const Lights1 lakitu_seg6_lights_06004CB0 =
    gdSPDefLights1(0x7f, 0x7f, 0x7f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x06004CC8
const Lights1 lakitu_seg6_lights_06004CC8 =
    gdSPDefLights1(0x0c, 0x0c, 0x0c, 0x19, 0x19, 0x19, 0x28, 0x28, 0x28);

// 0x06004CE0
const Lights1 lakitu_seg6_lights_06004CE0 =
    gdSPDefLights1(0x19, 0x22, 0x20, 0x32, 0x44, 0x40, 0x28, 0x28, 0x28);

// 0x06004CF8
const Lights1 lakitu_seg6_lights_06004CF8 =
    gdSPDefLights1(0x18, 0x18, 0x18, 0x30, 0x30, 0x30, 0x28, 0x28, 0x28);
...
const Gfx lakitu_seg6_dl_06005218[] = {
    gsSPLight(&lakitu_seg6_lights_06004CC8.l, 1),   gsSPLight(&lakitu_seg6_lights_06004CC8.a, 2),
    gsSPVertex(lakitu_seg6_vertex_06004D50, 15, 0), gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 5, 0x0),
    gsSP2Triangles(6, 7, 8, 0x0, 9, 10, 11, 0x0),   gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(lakitu_seg6_vertex_06004E40, 15, 0), gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 5, 0x0),
    gsSP2Triangles(6, 7, 8, 0x0, 9, 10, 11, 0x0),   gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(lakitu_seg6_vertex_06004F30, 6, 0),  gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 5, 0x0),
    gsSPLight(&lakitu_seg6_lights_06004CE0.l, 1),   gsSPLight(&lakitu_seg6_lights_06004CE0.a, 2),
    gsSPVertex(lakitu_seg6_vertex_06004F90, 14, 0), gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 5, 0x0),
    gsSP2Triangles(3, 5, 6, 0x0, 0, 7, 1, 0x0),     gsSP2Triangles(8, 9, 10, 0x0, 11, 12, 13, 0x0),
    gsSPVertex(lakitu_seg6_vertex_06005070, 14, 0), gsSP2Triangles(0, 1, 2, 0x0, 0, 2, 3, 0x0),
    gsSP2Triangles(4, 5, 6, 0x0, 7, 8, 9, 0x0),     gsSP2Triangles(10, 11, 12, 0x0, 10, 13, 11, 0x0),
    gsSPLight(&lakitu_seg6_lights_06004CF8.l, 1),   gsSPLight(&lakitu_seg6_lights_06004CF8.a, 2),
    gsSPVertex(lakitu_seg6_vertex_06005150, 8, 0),  gsSP2Triangles(0, 1, 2, 0x0, 0, 3, 4, 0x0),
    gsSP2Triangles(4, 5, 6, 0x0, 7, 1, 6, 0x0),     gsSPEndDisplayList(),
};
...
UNUSED const Lights1 lakitu_cameraman_lights_unused1 =
    gdSPDefLights1(0x33, 0x1f, 0x0c, 0xcc, 0x7f, 0x33, 0x28, 0x28, 0x28);

// 0x060053F0
const Lights1 lakitu_seg6_lights_060053F0 =
    gdSPDefLights1(0x29, 0x13, 0x06, 0xa5, 0x4f, 0x1b, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 lakitu_cameraman_lights_unused2 =
    gdSPDefLights1(0x06, 0x06, 0x06, 0x19, 0x19, 0x19, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 lakitu_cameraman_lights_unused3 =
    gdSPDefLights1(0x2c, 0x2c, 0x2c, 0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28);

// 0x06005438
const Lights1 lakitu_seg6_lights_06005438 =
    gdSPDefLights1(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 lakitu_cameraman_lights_unused4 =
    gdSPDefLights1(0x0d, 0x2c, 0x0b, 0x34, 0xb2, 0x2c, 0x28, 0x28, 0x28);
