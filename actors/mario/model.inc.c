...
const Lights1 mario_blue_lights_group =
...
const Lights1 mario_red_lights_group =
    gdSPDefLights1(0x7f, 0x00, 0x00, 0xff, 0x00, 0x00, 0x28, 0x28, 0x28);

// 0x04000030 # solid color white - metal butt & left thigh - normal left & right hand closed & open
// (with cap too) and all wings - all poly types
const Lights1 mario_white_lights_group =
    gdSPDefLights1(0x7f, 0x7f, 0x7f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x04000048 # solid color brown 1 - foot - all poly types
const Lights1 mario_brown1_lights_group =
    gdSPDefLights1(0x39, 0x0e, 0x07, 0x72, 0x1c, 0x0e, 0x28, 0x28, 0x28);

// 0x04000060 # solid color beige skin - face (cap on and off dls) - all poly types
const Lights1 mario_beige_lights_group =
    gdSPDefLights1(0x7f, 0x60, 0x3c, 0xfe, 0xc1, 0x79, 0x28, 0x28, 0x28);

// 0x04000078  # solid color brown 2 - hair - all poly types
const Lights1 mario_brown2_lights_group =
    gdSPDefLights1(0x39, 0x03, 0x00, 0x73, 0x06, 0x00, 0x28, 0x28, 0x28);
...
const Gfx mario_metal_butt[] = {
    ...
    gsDPLoadTextureBlock(mario_texture_metal, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 32, 0,
                         G_TX_WRAP | G_TX_NOMIRROR, G_TX_WRAP | G_TX_NOMIRROR, 6, 5, G_TX_NOLOD,
                         G_TX_NOLOD),
...
const Gfx mario_left_leg_shared_dl[] = {
    gsSPVertex(mario_left_leg_shared_dl_vertex, 12, 0), gsSP2Triangles(0, 1, 2, 0x0, 3, 2, 4, 0x0),
    gsSP2Triangles(3, 4, 5, 0x0, 6, 5, 7, 0x0),         gsSP2Triangles(0, 7, 1, 0x0, 0, 8, 7, 0x0),
    gsSP2Triangles(7, 8, 6, 0x0, 5, 6, 3, 0x0),         gsSP2Triangles(3, 9, 2, 0x0, 2, 9, 0, 0x0),
    gsSP2Triangles(3, 10, 9, 0x0, 5, 11, 7, 0x0),       gsSP2Triangles(7, 11, 1, 0x0, 1, 11, 2, 0x0),
    gsSP2Triangles(2, 11, 4, 0x0, 4, 11, 5, 0x0),       gsSP2Triangles(9, 10, 0, 0x0, 0, 10, 8, 0x0),
    gsSP2Triangles(8, 10, 6, 0x0, 6, 10, 3, 0x0),       gsSPEndDisplayList(),
};
...
const Gfx mario_face_cap_on_dl[] = {
    gsSPDisplayList(mario_face_part_cap_on_dl),      gsSPLight(&mario_red_lights_group.l, 1),
    gsSPLight(&mario_red_lights_group.a, 2),         gsSPDisplayList(mario_face_cap_dl),
    gsSPLight(&mario_brown2_lights_group.l, 1),      gsSPLight(&mario_brown2_lights_group.a, 2),
    gsSPDisplayList(mario_face_back_hair_cap_on_dl), gsSPEndDisplayList(),
};
...
UNUSED const Lights1 mario_lights_unused1 =
    gdSPDefLights1(0x3f, 0x30, 0x1e, 0xfe, 0xc1, 0x79, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 mario_lights_unused2 =
    gdSPDefLights1(0x1c, 0x01, 0x00, 0x73, 0x06, 0x00, 0x28, 0x28, 0x28);
...
const Gfx mario_metal_cap_off_shared_dl[] = {
    gsSPDisplayList(mario_eyes_cap_off_dl),          gsSPDisplayList(mario_mustache_cap_off_dl),
    gsSPDisplayList(mario_hair_sideburn_cap_off_dl), gsSPDisplayList(mario_face_part_cap_off_dl),
    gsSPDisplayList(mario_face_hair_cap_off_dl),     gsSPEndDisplayList(),
};
...
const Gfx mario_medium_poly_yellow_button_dl[] = {
    gsSPVertex(mario_seg4_vertex_04016148, 12, 0), gsSP2Triangles(0, 1, 2, 0x0, 3, 4, 1, 0x0),
    gsSP2Triangles(2, 1, 4, 0x0, 4, 5, 2, 0x0),    gsSP2Triangles(6, 7, 8, 0x0, 9, 10, 6, 0x0),
    gsSP2Triangles(6, 10, 7, 0x0, 7, 10, 11, 0x0), gsSPEndDisplayList(),
};
...
// 0x0401C758 - 0x0401C7E8 # Unreferenced, possibly a early duplicate of the cap object used in segment
// 03
...
// 0x0401C7E8 - 0x0401C890 # Unreferenced, possibly an early duplicate of the cap object used in segment
// 03
