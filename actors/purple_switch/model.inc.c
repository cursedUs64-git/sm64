...
// 0x0800C090
const Lights1 purple_switch_seg8_lights_0800C090 =
...
// 0x0800C528
const Vtx purple_switch_seg8_vertex_0800C528[] = {
...
// 0x0800C628
const Vtx purple_switch_seg8_vertex_0800C628[] = {
...
const Gfx purple_switch_seg8_dl_0800C718[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 4, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 2, G_TX_NOLOD,
