...
UNUSED const Lights1 unagi_lights_unused1 =
    gdSPDefLights1(0x2c, 0x25, 0x00, 0xb2, 0x94, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 unagi_lights_unused2 =
    gdSPDefLights1(0x35, 0x00, 0x00, 0xd5, 0x00, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 unagi_lights_unused3 =
    gdSPDefLights1(0x37, 0x00, 0x00, 0xdd, 0x00, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 unagi_lights_unused4 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 unagi_lights_unused5 =
    gdSPDefLights1(0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 unagi_lights_unused6 =
    gdSPDefLights1(0x34, 0x00, 0x00, 0xd2, 0x00, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 unagi_lights_unused7 =
    gdSPDefLights1(0x34, 0x00, 0x00, 0xd3, 0x00, 0x00, 0x28, 0x28, 0x28);

// Unreferenced light group
UNUSED const Lights1 unagi_lights_unused8 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);
...
const Gfx unagi_seg5_dl_0500CDD0[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 2, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 3, G_TX_NOLOD,
