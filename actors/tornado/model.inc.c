...
// 0x05014128
const Lights1 tornado_seg5_lights_05014128 =
    gdSPDefLights1(0x3b, 0x34, 0x23, 0xee, 0xd0, 0x8d, 0x28, 0x28, 0x28);
...
const Gfx tornado_seg5_dl_050145C0[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 6,
