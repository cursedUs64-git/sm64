...
// 0x05001BB8
const Lights1 capswitch_seg5_lights_05001BB8 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x05001BD0
const Lights1 capswitch_seg5_lights_05001BD0 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x05001BE8
const Lights1 capswitch_seg5_lights_05001BE8 =
    gdSPDefLights1(0x3f, 0x00, 0x00, 0xff, 0x00, 0x00, 0x28, 0x28, 0x28);

// 0x05001C00
const Lights1 capswitch_seg5_lights_05001C00 =
    gdSPDefLights1(0x01, 0x2a, 0x09, 0x07, 0xa9, 0x25, 0x28, 0x28, 0x28);

// 0x05001C18
const Lights1 capswitch_seg5_lights_05001C18 =
    gdSPDefLights1(0x00, 0x00, 0x3f, 0x00, 0x00, 0xff, 0x28, 0x28, 0x28);

// 0x05001C30
const Lights1 capswitch_seg5_lights_05001C30 =
    gdSPDefLights1(0x3f, 0x25, 0x02, 0xff, 0x96, 0x08, 0x28, 0x28, 0x28);
...
const Gfx cap_switch_exclamation_seg5_dl_05002E00[] = {
    ...
    gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR,
                G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 6, G_TX_NOLOD,
...
const Gfx cap_switch_base_seg5_dl_05003120[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 4, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 2,
...
const Gfx capswitch_seg5_dl_05003280[] = {
    gsSPVertex(capswitch_seg5_vertex_05003180, 16, 0), gsSP2Triangles(0, 1, 2, 0x0, 1, 3, 4, 0x0),
    gsSP2Triangles(1, 0, 3, 0x0, 2, 5, 0, 0x0),        gsSP2Triangles(0, 5, 6, 0x0, 7, 3, 0, 0x0),
    gsSP2Triangles(6, 7, 0, 0x0, 8, 3, 7, 0x0),        gsSP2Triangles(4, 3, 8, 0x0, 9, 10, 5, 0x0),
    gsSP2Triangles(11, 6, 5, 0x0, 5, 10, 11, 0x0),     gsSP2Triangles(5, 2, 9, 0x0, 10, 9, 12, 0x0),
    gsSP2Triangles(12, 13, 10, 0x0, 10, 13, 11, 0x0),  gsSP2Triangles(6, 11, 14, 0x0, 14, 11, 13, 0x0),
    gsSP2Triangles(6, 14, 7, 0x0, 15, 8, 13, 0x0),     gsSP2Triangles(13, 8, 14, 0x0, 13, 12, 15, 0x0),
    gsSP2Triangles(8, 15, 4, 0x0, 7, 14, 8, 0x0),      gsSPEndDisplayList(),
};
