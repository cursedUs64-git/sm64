...
#define DEFINE_DIALOG(id, _1, _2, _3, _4, str) const u8 dialog_text_##id[] = { str };

#include "dialogs.h"

#undef DEFINE_DIALOG
#define DEFINE_DIALOG(id, unused, linesPerBox, leftOffset, width, _)                                   \
    const struct DialogEntry dialog_entry_##id = { unused, linesPerBox, leftOffset, width,             \
                                                   dialog_text_##id };
...
#undef EXTRA_TEXT
#define EXTRA_TEXT(id, str) const u8 extra_text_##id[] = { str };
...
#define COURSE_ACTS(id, name, a, b, c, d, e, f)                                                        \
    act_name_##id##_1, act_name_##id##_2, act_name_##id##_3, act_name_##id##_4, act_name_##id##_5,     \
        act_name_##id##_6,
