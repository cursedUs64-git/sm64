#define COURSE_ACTS(id, name, a, b, c, d, e, f) const u8 GLUE2(COURSE_TABLE, _##id)[] = { name };

#define SECRET_STAR(id, name) const u8 GLUE2(COURSE_TABLE, _##id)[] = { name };

#define CASTLE_SECRET_STARS(str) const u8 GLUE2(COURSE_TABLE, _castle_secret_stars)[] = { str };
