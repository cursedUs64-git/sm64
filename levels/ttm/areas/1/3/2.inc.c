...
const Vtx ttm_seg7_vertex_0700A9C0[] = {
...
const Gfx ttm_seg7_dl_0700AA40[] = {
...
const Gfx ttm_seg7_dl_0700AAB8[] = {
    gsSPVertex(ttm_seg7_vertex_0700A9C0, 8, 0), gsSP2Triangles(0, 1, 2, 0x0, 2, 1, 3, 0x0),
    gsSP2Triangles(2, 3, 4, 0x0, 0, 5, 1, 0x0), gsSP2Triangles(4, 3, 6, 0x0, 4, 6, 7, 0x0),
    gsSP2Triangles(7, 5, 0, 0x0, 7, 6, 5, 0x0), gsSPEndDisplayList(),
};
