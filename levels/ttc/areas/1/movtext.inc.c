...
const Lights1 ttc_lights_surface_treadmill =
...
const Gfx ttc_dl_surface_treadmill[] = {
    gsSP2Triangles(0, 1, 6, 0x0, 1, 7, 6, 0x0),    gsSP2Triangles(1, 2, 7, 0x0, 2, 8, 7, 0x0),
    gsSP2Triangles(2, 3, 8, 0x0, 3, 9, 8, 0x0),    gsSP2Triangles(3, 4, 9, 0x0, 4, 10, 9, 0x0),
    gsSP2Triangles(4, 5, 10, 0x0, 5, 11, 10, 0x0), gsSPEndDisplayList(),
};
