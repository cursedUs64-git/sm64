...
const LevelScript script_exec_level_table[2
#include "level_defines.h"
];
#undef DEFINE_LEVEL
#undef STUB_LEVEL

const LevelScript script_L1[4];
const LevelScript script_L2[4];
const LevelScript goto_mario_head_regular[4];
const LevelScript goto_mario_head_dizzy[4];
const LevelScript script_L5[4];

#define STUB_LEVEL(_0, _1, _2, _3, _4, _5, _6, _7, _8)
#define DEFINE_LEVEL(_0, _1, _2, folder, _4, _5, _6, _7, _8, _9, _10)                                  \
    const LevelScript script_exec_##folder[4 + 1];
...
const LevelScript script_func_global_7[] = {
    LOAD_MODEL_FROM_DL(MODEL_DL_MONTY_MOLE_HOLE, monty_mole_hole_seg5_dl_05000840,
...
const LevelScript script_func_global_9[] = {
    LOAD_MODEL_FROM_DL(MODEL_CAP_SWITCH_EXCLAMATION, cap_switch_exclamation_seg5_dl_05002E00,
                       LAYER_ALPHA),
