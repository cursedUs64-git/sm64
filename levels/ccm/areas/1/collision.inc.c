...
const Collision ccm_seg7_area_1_collision[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(21),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start, /*pos*/ -1512, 2560, -2305,
                            /*yaw*/ 100), // unused, probably an early way to set initial position
    ...
    SPECIAL_OBJECT_WITH_YAW_AND_PARAM(/*preset*/ special_wooden_door_warp, /*pos*/ 2464, -4607, 4302,
                                      /*yaw*/ 158, /*bhvParam2*/ 20),
