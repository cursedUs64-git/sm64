...
const MacroObject vcutm_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_hidden_1up, /*yaw*/ 0, /*pos*/ 4460, 0, -4700,
                                /*bhvParam*/ 3),
    ...
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_circling_amp, /*yaw*/ 0, /*pos*/ -2100, -2800, -3866,
