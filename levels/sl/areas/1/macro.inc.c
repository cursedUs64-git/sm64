...
const MacroObject sl_seg7_area_1_macro_objs[] = {
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_wooden_signpost, /*yaw*/ 90, /*pos*/ 4086, 1024, 400,
                                /*bhvParam*/ DIALOG_086),
    ...
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_cannon_closed, /*yaw*/ 0, /*pos*/ 4483, 821, 1168,
                                /*bhvParam*/ 0x80),
    ...
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_circling_amp, /*yaw*/ 0, /*pos*/ 4060, 900, -2940,
                                /*bhvParam*/ AMP_BP_ROT_RADIUS_200),
    ...
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_wooden_signpost, /*yaw*/ 295, /*pos*/ -835, 1125,
                                -3856, /*bhvParam*/ DIALOG_061),
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_wooden_signpost, /*yaw*/ 180, /*pos*/ -5050, 1020,
                                6026, /*bhvParam*/ DIALOG_016),
    MACRO_OBJECT(/*preset*/ macro_fly_guy, /*yaw*/ 0, /*pos*/ 2766, 1522, -3633),
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_wooden_signpost, /*yaw*/ 135, /*pos*/ -3600, 1024,
                                -800, /*bhvParam*/ DIALOG_148),
