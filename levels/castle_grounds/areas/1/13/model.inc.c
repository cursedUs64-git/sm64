...
const Gfx castle_grounds_seg7_us_dl_0700F2E8[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_8b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD,
    ...
    gsSPTextureRectangle(116 << 2, 166 << 2, (116 + 64) << 2, (166 + 32) << 2, G_TX_RENDERTILE, 0, 0,
                         1 << 10, 1 << 10),
    gsDPPipeSync(),
