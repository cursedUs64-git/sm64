...
const MacroObject wmotr_seg7_macro_objs[] = {
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_cannon_closed, /*yaw*/ 0, /*pos*/ -4456, 827, 191,
                                /*bhvParam*/ 0x00),
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_cannon_closed, /*yaw*/ 0, /*pos*/ 3712, -2740, 5200,
                                /*bhvParam*/ 0x80),
