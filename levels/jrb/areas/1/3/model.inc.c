...
const Lights1 jrb_seg7_lights_07004A18 =
    gdSPDefLights1(0x1e, 0x27, 0x3a, 0x79, 0x9f, 0xeb, 0x28, 0x28, 0x28);

// 0x07004A30 - 0x07004A48
const Lights1 jrb_seg7_lights_07004A30 =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);

// 0x07004A48 - 0x07004AC8
const Vtx jrb_seg7_vertex_07004A48[] = {
...
const Vtx jrb_seg7_vertex_07004AC8[] = {
...
const Gfx jrb_seg7_dl_07004B88[] = {
...
const Gfx jrb_seg7_dl_07004BF0[] = {
...
const Gfx jrb_seg7_dl_07004C78[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 5,
                G_TX_NOLOD, G_TX_CLAMP, 6, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (64 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
