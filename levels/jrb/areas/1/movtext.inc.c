...
Movtex jrb_movtex_ocean_cave_water_data[] = {
    MOV_TEX_INIT_LOAD(1),
...
// 0x0700D2E4, appears if you enter the course the first time, then it disappears when you collect the
// "Plunder in the Sunken Ship" star
Movtex jrb_movtex_initial_mist_data[] = {
    MOV_TEX_INIT_LOAD(1),
    MOV_TEX_ROT_SPEED(20),
