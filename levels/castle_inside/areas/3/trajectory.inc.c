...
const Trajectory inside_castle_seg7_trajectory_mips_1[] = {
    TRAJECTORY_POS(0, /*pos*/ -3674, -1379, -962),  TRAJECTORY_POS(1, /*pos*/ -3813, -1279, -41),
    TRAJECTORY_POS(2, /*pos*/ -3628, -1279, 755),   TRAJECTORY_POS(3, /*pos*/ -2210, -1192, 715),
    TRAJECTORY_POS(4, /*pos*/ -1810, -1177, 284),   TRAJECTORY_POS(5, /*pos*/ -1842, -1177, -1078),
    TRAJECTORY_POS(6, /*pos*/ -1604, -1177, -1445), TRAJECTORY_END(),
};
...
const Trajectory inside_castle_seg7_trajectory_mips_3[] = {
    TRAJECTORY_POS(0, /*pos*/ -2019, -1279, -3077), TRAJECTORY_POS(1, /*pos*/ -2559, -1279, -3043),
    TRAJECTORY_POS(2, /*pos*/ -2957, -1279, -2747), TRAJECTORY_POS(3, /*pos*/ -3031, -1262, -1947),
    TRAJECTORY_POS(4, /*pos*/ -2846, -1262, -1321), TRAJECTORY_END(),
};

// 0x07078FA8 - 0x07078FD4
const Trajectory inside_castle_seg7_trajectory_mips_4[] = {
    TRAJECTORY_POS(0, /*pos*/ -3005, -1197, -1874), TRAJECTORY_POS(1, /*pos*/ -2967, -1279, -2582),
    TRAJECTORY_POS(2, /*pos*/ -2559, -1279, -3043), TRAJECTORY_POS(3, /*pos*/ -1984, -1262, -3068),
    TRAJECTORY_POS(4, /*pos*/ -1432, -1262, -3038), TRAJECTORY_END(),
};
