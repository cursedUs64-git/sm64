...
const MacroObject inside_castle_seg7_area_3_macro_objs[] = {
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_sign_on_wall, /*yaw*/ 0, /*pos*/ 6400, -1178, -1270,
                                /*bhvParam*/ DIALOG_077),
    ...
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_hidden_1up, /*yaw*/ 0, /*pos*/ 2861, -2508, -515,
                                /*bhvParam*/ 4),
    MACRO_OBJECT_END(),
};
