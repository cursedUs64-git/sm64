...
const Collision inside_castle_seg7_area_1_collision[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(11),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start, /*pos*/ -1023, 0, 1152,
                            /*yaw*/ 128), // unused, probably an early way to set initial position
    ...
    SPECIAL_OBJECT_WITH_YAW_AND_PARAM(/*preset*/ special_castle_door_warp, /*pos*/ -1100, 0, 2202,
                                      /*yaw*/ 0, /*bhvParam2*/ 0),
    SPECIAL_OBJECT_WITH_YAW_AND_PARAM(/*preset*/ special_castle_door_warp, /*pos*/ -946, 0, 2202,
                                      /*yaw*/ 128, /*bhvParam2*/ 1),
    SPECIAL_OBJECT_WITH_YAW_AND_PARAM(/*preset*/ special_wooden_door_warp, /*pos*/ -1023, -101, -5170,
                                      /*yaw*/ 0, /*bhvParam2*/ 2),
