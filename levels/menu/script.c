...
const LevelScript level_main_menu_entry_1[] = {
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, 0, -19000, /*angle*/ 0, 0, 0, /*bhvParam*/ BPARAM1(0x04),
           /*bhv*/ bhvMenuButtonManager),
    OBJECT(/*model*/ MODEL_MAIN_MENU_YELLOW_FILE_BUTTON, /*pos*/ 0, 0, -19000, /*angle*/ 0, 0, 0,
           /*bhvParam*/ BPARAM1(0x04), /*bhv*/ bhvYellowBackgroundInMenu),
    ...
    EXIT_AND_EXECUTE(/*seg*/ 0x15, _scriptsSegmentRomStart, _scriptsSegmentRomEnd,
...
const LevelScript level_main_menu_entry_2[] = {
    ...
    /*16*/
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, -100, 0, /*angle*/ 0, 0, 0, /*bhvParam*/ BPARAM1(0x04),
           /*bhv*/ bhvActSelector),
    ...
    // sVisibleStars is set to 0 during FIXED_LOAD above on N64, but not when NO_SEGMENTED_MEMORY is
    // used. lvl_init_act_selector_values_and_stars must be called here otherwise the previous value is
    // retained and causes incorrect drawing during the 16 transition frames.
