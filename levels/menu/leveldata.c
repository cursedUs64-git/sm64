...
const Lights1 lights_menu_save_button =
...
const Vtx vertex_menu_save_button_borders[] = {
...
const Vtx vertex_menu_save_button_front[] = {
...
const Gfx dl_tex_block_menu_save_button_base[] = {
    gsDPPipeSync(),
...
const Gfx dl_vertex_menu_save_button_borders[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 5,
                G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 6, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (64 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPEndDisplayList(),
};

// 0x07003218 - 0x07003258
const Gfx dl_vertex_menu_save_button_front[] = {
...
const Vtx vertex_menu_save_button_back[] = {
...
const Gfx dl_tex_block_menu_save_button_back[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_SHADING_SMOOTH),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR,
...
const Gfx dl_vertex_menu_save_button_back[] = {
    gsSPLight(&lights_menu_save_button.l, 1),
    gsSPLight(&lights_menu_save_button.a, 2),
...
const Lights1 lights_menu_main_button =
    gdSPDefLights1(0x3f, 0x3f, 0x3f, 0xff, 0xff, 0xff, 0x28, 0x28, 0x28);
...
const Vtx vertex_menu_main_button_group1[] = {
...
const Vtx vertex_menu_main_button_group2[] = {
    { { { 143, -102, 0 }, 0, { 32, 54 }, { 0xa7, 0x00, 0xa7, 0xff } } },
...
const Vtx vertex_menu_main_button_group3[] = {
    { { { 163, 122, 0 }, 0, { 0, 990 }, { 0x00, 0x00, 0x81, 0xff } } },
...
const Vtx vertex_menu_main_button_group4[] = {
...
const Gfx dl_tex_block_menu_main_button[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_SHADING_SMOOTH),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR,
...
const Texture *const menu_hud_lut[] = {
    texture_menu_hud_char_katakana_hu,        texture_menu_hud_char_katakana_small_a,
    texture_menu_hud_char_katakana_i,         texture_menu_hud_char_katakana_ru,
    texture_menu_hud_char_katakana_se,        texture_menu_hud_char_katakana_re,
    texture_menu_hud_char_katakana_ku,        texture_menu_hud_char_katakana_to,
    texture_menu_hud_char_hiragana_wo,        texture_menu_hud_char_katakana_ko,
    texture_menu_hud_char_kana_handakuten_pi, texture_menu_hud_char_choonpu,
    texture_menu_hud_char_hiragana_su,        texture_menu_hud_char_hiragana_ru,
    texture_menu_hud_char_hiragana_ke,        texture_menu_hud_char_katakana_ma,
    texture_menu_hud_char_katakana_ri,        texture_menu_hud_char_katakana_o,
    texture_menu_hud_char_katakana_su,        texture_menu_hud_char_katakana_a,
    ...
    texture_menu_hud_char_katakana_n,         texture_menu_hud_char_kana_dakuten_do,
};

#if defined(VERSION_JP) || defined(VERSION_SH)
UNUSED const u64 menu_unused_0 = 0;

// 0x0700AC48
ALIGNED8 const Texture texture_menu_font_char_jp_0[] = {
...
// 0x0700ACC8
ALIGNED8 const Texture texture_menu_font_char_jp_2[] = {
#include "levels/menu/main_menu_seg7.0ACC8.ia8.inc.c"
};

// 0x0700AD08
ALIGNED8 const Texture texture_menu_font_char_jp_3[] = {
#include "levels/menu/main_menu_seg7.0AD08.ia8.inc.c"
};

// 0x0700AD48
ALIGNED8 const Texture texture_menu_font_char_jp_4[] = {
#include "levels/menu/main_menu_seg7.0AD48.ia8.inc.c"
};

// 0x0700AD88
ALIGNED8 const Texture texture_menu_font_char_jp_5[] = {
#include "levels/menu/main_menu_seg7.0AD88.ia8.inc.c"
};

// 0x0700ADC8
ALIGNED8 const Texture texture_menu_font_char_jp_6[] = {
#include "levels/menu/main_menu_seg7.0ADC8.ia8.inc.c"
};

// 0x0700AE08
ALIGNED8 const Texture texture_menu_font_char_jp_7[] = {
#include "levels/menu/main_menu_seg7.0AE08.ia8.inc.c"
};

// 0x0700AE48
ALIGNED8 const Texture texture_menu_font_char_jp_8[] = {
#include "levels/menu/main_menu_seg7.0AE48.ia8.inc.c"
};

// 0x0700AE88
ALIGNED8 const Texture texture_menu_font_char_jp_9[] = {
...
// 0x0700AF08
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_i[] = {
#include "levels/menu/main_menu_seg7.0AF08.ia8.inc.c"
};

// 0x0700AF48
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_u[] = {
#include "levels/menu/main_menu_seg7.0AF48.ia8.inc.c"
};

// 0x0700AF88
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_c[] = {
#include "levels/menu/main_menu_seg7.0AF88.ia8.inc.c"
};

// 0x0700AFC8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_o[] = {
#include "levels/menu/main_menu_seg7.0AFC8.ia8.inc.c"
};

// 0x0700B008
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ka[] = {
#include "levels/menu/main_menu_seg7.0B008.ia8.inc.c"
};

// 0x0700B048
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ki[] = {
#include "levels/menu/main_menu_seg7.0B048.ia8.inc.c"
};

// 0x0700B088
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ku[] = {
...
// 0x0700B148
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_sa[] = {
...
// 0x0700B1C8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_su[] = {
#include "levels/menu/main_menu_seg7.0B1C8.ia8.inc.c"
};

// 0x0700B208
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_se[] = {
#include "levels/menu/main_menu_seg7.0B208.ia8.inc.c"
};

// 0x0700B248
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_so[] = {
#include "levels/menu/main_menu_seg7.0B248.ia8.inc.c"
};

// 0x0700B288
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ta[] = {
#include "levels/menu/main_menu_seg7.0B288.ia8.inc.c"
};

// 0x0700B2C8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_chi[] = {
#include "levels/menu/main_menu_seg7.0B2C8.ia8.inc.c"
};

// 0x0700B308
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_tsu[] = {
#include "levels/menu/main_menu_seg7.0B308.ia8.inc.c"
};

// 0x0700B348
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_te[] = {
#include "levels/menu/main_menu_seg7.0B348.ia8.inc.c"
};

// 0x0700B388
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_to[] = {
#include "levels/menu/main_menu_seg7.0B388.ia8.inc.c"
};

// 0x0700B3C8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_na[] = {
...
// 0x0700B448
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_nu[] = {
#include "levels/menu/main_menu_seg7.0B448.ia8.inc.c"
};

// 0x0700B488
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ne[] = {
#include "levels/menu/main_menu_seg7.0B488.ia8.inc.c"
};

// 0x0700B4C8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_no[] = {
#include "levels/menu/main_menu_seg7.0B4C8.ia8.inc.c"
};

// 0x0700B508
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ha[] = {
...
// 0x0700B588
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_hu[] = {
#include "levels/menu/main_menu_seg7.0B588.ia8.inc.c"
};

// 0x0700B5C8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_he[] = {
...
// 0x0700B648
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ma[] = {
#include "levels/menu/main_menu_seg7.0B648.ia8.inc.c"
};

// 0x0700B688
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_mi[] = {
#include "levels/menu/main_menu_seg7.0B688.ia8.inc.c"
};

// 0x0700B6C8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_mu[] = {
#include "levels/menu/main_menu_seg7.0B6C8.ia8.inc.c"
};

// 0x0700B708
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_me[] = {
#include "levels/menu/main_menu_seg7.0B708.ia8.inc.c"
};

// 0x0700B748
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_mo[] = {
...
// 0x0700B7C8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_yu[] = {
...
// 0x0700B848
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ra[] = {
...
// 0x0700B8C8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ru[] = {
#include "levels/menu/main_menu_seg7.0B8C8.ia8.inc.c"
};

// 0x0700B908
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_re[] = {
#include "levels/menu/main_menu_seg7.0B908.ia8.inc.c"
};

// 0x0700B948
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_ro[] = {
#include "levels/menu/main_menu_seg7.0B948.ia8.inc.c"
};

// 0x0700B988
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_wa[] = {
...
// 0x0700BA08
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_n[] = {
#include "levels/menu/main_menu_seg7.0BA08.ia8.inc.c"
};

// 0x0700BA48
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_small_a[] = {
#include "levels/menu/main_menu_seg7.0BA48.ia8.inc.c"
};

// 0x0700BA88
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_small_i[] = {
#include "levels/menu/main_menu_seg7.0BA88.ia8.inc.c"
};

// 0x0700BAC8
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_small_u[] = {
#include "levels/menu/main_menu_seg7.0BAC8.ia8.inc.c"
};

// 0x0700BB08
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_small_e[] = {
#include "levels/menu/main_menu_seg7.0BB08.ia8.inc.c"
};

// 0x0700BB48
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_small_o[] = {
...
// 0x0700BC48
ALIGNED8 const Texture texture_menu_font_char_jp_hiragana_small_tsu[] = {
#include "levels/menu/main_menu_seg7.0BC48.ia8.inc.c"
};

// 0x0700BC88
ALIGNED8 const Texture texture_menu_font_char_jp_handakuten[] = {
...
// 0x0700BD08
ALIGNED8 const Texture texture_menu_font_char_jp_long_vowel[] = {
#include "levels/menu/main_menu_seg7.0BD08.ia8.inc.c"
};

// 0x0700BD48
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_a[] = {
...
// 0x0700BDC8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_u[] = {
...
// 0x0700BE88
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ka[] = {
...
// 0x0700BF08
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ku[] = {
#include "levels/menu/main_menu_seg7.0BF08.ia8.inc.c"
};

// 0x0700BF48
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ke[] = {
#include "levels/menu/main_menu_seg7.0BF48.ia8.inc.c"
};

// 0x0700BF88
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ko[] = {
...
// 0x0700C088
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_se[] = {
#include "levels/menu/main_menu_seg7.0C088.ia8.inc.c"
};

// 0x0700C0C8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_so[] = {
...
// 0x0700C148
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_chi[] = {
#include "levels/menu/main_menu_seg7.0C148.ia8.inc.c"
};

// 0x0700C188
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_tsu[] = {
#include "levels/menu/main_menu_seg7.0C188.ia8.inc.c"
};

// 0x0700C1C8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_te[] = {
#include "levels/menu/main_menu_seg7.0C1C8.ia8.inc.c"
};

// 0x0700C208
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_to[] = {
#include "levels/menu/main_menu_seg7.0C208.ia8.inc.c"
};

// 0x0700C248
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_na[] = {
...
// 0x0700C2C8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_nu[] = {
#include "levels/menu/main_menu_seg7.0C2C8.ia8.inc.c"
};

// 0x0700C308
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ne[] = {
...
// 0x0700C3C8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_hi[] = {
#include "levels/menu/main_menu_seg7.0C3C8.ia8.inc.c"
};

// 0x0700C408
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_hu[] = {
#include "levels/menu/main_menu_seg7.0C408.ia8.inc.c"
};

// 0x0700C448
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_he[] = {
#include "levels/menu/main_menu_seg7.0C448.ia8.inc.c"
};

// 0x0700C488
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ho[] = {
#include "levels/menu/main_menu_seg7.0C488.ia8.inc.c"
};

// 0x0700C4C8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ma[] = {
#include "levels/menu/main_menu_seg7.0C4C8.ia8.inc.c"
};

// 0x0700C508
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_mi[] = {
...
// 0x0700C588
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_me[] = {
#include "levels/menu/main_menu_seg7.0C588.ia8.inc.c"
};

// 0x0700C5C8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_mo[] = {
#include "levels/menu/main_menu_seg7.0C5C8.ia8.inc.c"
};

// 0x0700C608
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ya[] = {
#include "levels/menu/main_menu_seg7.0C608.ia8.inc.c"
};

// 0x0700C648
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_yu[] = {
#include "levels/menu/main_menu_seg7.0C648.ia8.inc.c"
};

// 0x0700C688
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_yo[] = {
#include "levels/menu/main_menu_seg7.0C688.ia8.inc.c"
};

// 0x0700C6C8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ra[] = {
#include "levels/menu/main_menu_seg7.0C6C8.ia8.inc.c"
};

// 0x0700C708
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ri[] = {
#include "levels/menu/main_menu_seg7.0C708.ia8.inc.c"
};

// 0x0700C748
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ru[] = {
#include "levels/menu/main_menu_seg7.0C748.ia8.inc.c"
};

// 0x0700C788
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_re[] = {
#include "levels/menu/main_menu_seg7.0C788.ia8.inc.c"
};

// 0x0700C7C8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_ro[] = {
#include "levels/menu/main_menu_seg7.0C7C8.ia8.inc.c"
};

// 0x0700C808
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_wa[] = {
#include "levels/menu/main_menu_seg7.0C808.ia8.inc.c"
};

// 0x0700C848
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_wo[] = {
...
// 0x0700C948
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_small_u[] = {
#include "levels/menu/main_menu_seg7.0C948.ia8.inc.c"
};

// 0x0700C988
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_small_e[] = {
...
// 0x0700CA88
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_small_yo[] = {
#include "levels/menu/main_menu_seg7.0CA88.ia8.inc.c"
};

// 0x0700CAC8
ALIGNED8 const Texture texture_menu_font_char_jp_katakana_small_tsu[] = {
#include "levels/menu/main_menu_seg7.0CAC8.ia8.inc.c"
};

// 0x0700CB08
ALIGNED8 const Texture texture_menu_font_char_jp_A[] = {
#include "levels/menu/main_menu_seg7.0CB08.ia8.inc.c"
};

// 0x0700CB48
ALIGNED8 const Texture texture_menu_font_char_jp_B[] = {
...
// 0x0700CBC8
ALIGNED8 const Texture texture_menu_font_char_jp_D[] = {
#include "levels/menu/main_menu_seg7.0CBC8.ia8.inc.c"
};

// 0x0700CC08
ALIGNED8 const Texture texture_menu_font_char_jp_coin[] = {
#include "levels/menu/main_menu_seg7.0CC08.ia8.inc.c"
};

// 0x0700CC48
ALIGNED8 const Texture texture_menu_font_char_jp_star_filled[] = {
#include "levels/menu/main_menu_seg7.0CC48.ia8.inc.c"
};

// 0x0700CC88
ALIGNED8 const Texture texture_menu_font_char_jp_multiply[] = {
#include "levels/menu/main_menu_seg7.0CC88.ia8.inc.c"
};

// 0x0700CCC8
ALIGNED8 const Texture texture_menu_font_char_jp_exclamation[] = {
...
const Texture *const menu_font_lut[] = {
#if defined(VERSION_JP) || defined(VERSION_SH)
    texture_menu_font_char_jp_0,
    texture_menu_font_char_jp_1,
    texture_menu_font_char_jp_2,
    texture_menu_font_char_jp_3,
    texture_menu_font_char_jp_4,
    texture_menu_font_char_jp_5,
    texture_menu_font_char_jp_6,
    texture_menu_font_char_jp_7,
    texture_menu_font_char_jp_8,
    texture_menu_font_char_jp_9,
    texture_menu_font_char_jp_A,
    texture_menu_font_char_jp_B,
    texture_menu_font_char_jp_C,
    ...
    0x0,
    0x0,
    texture_menu_font_char_jp_hiragana_a,
    texture_menu_font_char_jp_hiragana_i,
    texture_menu_font_char_jp_hiragana_u,
    texture_menu_font_char_jp_hiragana_c,
    texture_menu_font_char_jp_hiragana_o,
    texture_menu_font_char_jp_hiragana_ka,
    texture_menu_font_char_jp_hiragana_ki,
    texture_menu_font_char_jp_hiragana_ku,
    texture_menu_font_char_jp_hiragana_ke,
    texture_menu_font_char_jp_hiragana_ko,
    texture_menu_font_char_jp_hiragana_sa,
    texture_menu_font_char_jp_hiragana_shi,
    texture_menu_font_char_jp_hiragana_su,
    texture_menu_font_char_jp_hiragana_se,
    texture_menu_font_char_jp_hiragana_so,
    texture_menu_font_char_jp_hiragana_ta,
    texture_menu_font_char_jp_hiragana_chi,
    texture_menu_font_char_jp_hiragana_tsu,
    texture_menu_font_char_jp_hiragana_te,
    texture_menu_font_char_jp_hiragana_to,
    texture_menu_font_char_jp_hiragana_na,
    texture_menu_font_char_jp_hiragana_ni,
    texture_menu_font_char_jp_hiragana_nu,
    texture_menu_font_char_jp_hiragana_ne,
    texture_menu_font_char_jp_hiragana_no,
    texture_menu_font_char_jp_hiragana_ha,
    texture_menu_font_char_jp_hiragana_hi,
    texture_menu_font_char_jp_hiragana_hu,
    texture_menu_font_char_jp_hiragana_he,
    texture_menu_font_char_jp_hiragana_ho,
    texture_menu_font_char_jp_hiragana_ma,
    texture_menu_font_char_jp_hiragana_mi,
    texture_menu_font_char_jp_hiragana_mu,
    texture_menu_font_char_jp_hiragana_me,
    texture_menu_font_char_jp_hiragana_mo,
    texture_menu_font_char_jp_hiragana_ya,
    texture_menu_font_char_jp_hiragana_yu,
    texture_menu_font_char_jp_hiragana_yo,
    texture_menu_font_char_jp_hiragana_ra,
    texture_menu_font_char_jp_hiragana_ri,
    texture_menu_font_char_jp_hiragana_ru,
    texture_menu_font_char_jp_hiragana_re,
    texture_menu_font_char_jp_hiragana_ro,
    texture_menu_font_char_jp_hiragana_wa,
    texture_menu_font_char_jp_hiragana_wo,
    texture_menu_font_char_jp_hiragana_n,
    0x0,
    0x0,
    texture_menu_font_char_jp_katakana_a,
    texture_menu_font_char_jp_katakana_i,
    texture_menu_font_char_jp_katakana_u,
    texture_menu_font_char_jp_katakana_e,
    texture_menu_font_char_jp_katakana_o,
    texture_menu_font_char_jp_katakana_ka,
    texture_menu_font_char_jp_katakana_ki,
    texture_menu_font_char_jp_katakana_ku,
    texture_menu_font_char_jp_katakana_ke,
    texture_menu_font_char_jp_katakana_ko,
    texture_menu_font_char_jp_katakana_sa,
    texture_menu_font_char_jp_katakana_shi,
    texture_menu_font_char_jp_katakana_su,
    texture_menu_font_char_jp_katakana_se,
    texture_menu_font_char_jp_katakana_so,
    texture_menu_font_char_jp_katakana_ta,
    texture_menu_font_char_jp_katakana_chi,
    texture_menu_font_char_jp_katakana_tsu,
    texture_menu_font_char_jp_katakana_te,
    texture_menu_font_char_jp_katakana_to,
    texture_menu_font_char_jp_katakana_na,
    texture_menu_font_char_jp_katakana_ni,
    texture_menu_font_char_jp_katakana_nu,
    texture_menu_font_char_jp_katakana_ne,
    texture_menu_font_char_jp_katakana_no,
    texture_menu_font_char_jp_katakana_ha,
    texture_menu_font_char_jp_katakana_hi,
    texture_menu_font_char_jp_katakana_hu,
    texture_menu_font_char_jp_katakana_he,
    texture_menu_font_char_jp_katakana_ho,
    texture_menu_font_char_jp_katakana_ma,
    texture_menu_font_char_jp_katakana_mi,
    texture_menu_font_char_jp_katakana_mu,
    texture_menu_font_char_jp_katakana_me,
    texture_menu_font_char_jp_katakana_mo,
    texture_menu_font_char_jp_katakana_ya,
    texture_menu_font_char_jp_katakana_yu,
    texture_menu_font_char_jp_katakana_yo,
    texture_menu_font_char_jp_katakana_ra,
    texture_menu_font_char_jp_katakana_ri,
    texture_menu_font_char_jp_katakana_ru,
    texture_menu_font_char_jp_katakana_re,
    texture_menu_font_char_jp_katakana_ro,
    texture_menu_font_char_jp_katakana_wa,
    texture_menu_font_char_jp_katakana_wo,
    texture_menu_font_char_jp_katakana_n,
    0x0,
    texture_menu_font_char_jp_long_vowel,
    texture_menu_font_char_jp_hiragana_small_e,
    texture_menu_font_char_jp_hiragana_small_tsu,
    texture_menu_font_char_jp_hiragana_small_ka,
    texture_menu_font_char_jp_hiragana_small_yu,
    texture_menu_font_char_jp_hiragana_small_yo,
    texture_menu_font_char_jp_hiragana_small_a,
    texture_menu_font_char_jp_hiragana_small_i,
    texture_menu_font_char_jp_hiragana_small_u,
    texture_menu_font_char_jp_hiragana_small_o,
    0x0,
    0x0,
    0x0,
    0x0,
    ...
    0x0,
    0x0,
    texture_menu_font_char_jp_katakana_small_e,
    texture_menu_font_char_jp_katakana_small_tsu,
    texture_menu_font_char_jp_katakana_small_ka,
    texture_menu_font_char_jp_katakana_small_yu,
    texture_menu_font_char_jp_katakana_small_yo,
    texture_menu_font_char_jp_katakana_small_a,
    texture_menu_font_char_jp_katakana_small_i,
    texture_menu_font_char_jp_katakana_small_u,
    texture_menu_font_char_jp_katakana_small_o,
    0x0,
    0x0,
    0x0,
    0x0,
    ...
    0x0,
    0x0,
    texture_menu_font_char_jp_dakuten,
    texture_menu_font_char_jp_handakuten,
    texture_menu_font_char_jp_exclamation,
    0x0,
    0x0,
    0x0,
    0x0,
    0x0,
    0x0,
    texture_menu_font_char_jp_coin,
    texture_menu_font_char_jp_star_filled,
    texture_menu_font_char_jp_multiply,
    0x0,
    0x0,
    0x0,
    0x0,
...
UNUSED const u64 menu_unused_1 = 0;
...
const Vtx vertex_menu_course_upper[] = {
...
const Vtx vertex_menu_course_lower[] = {
...
const Gfx dl_menu_rgba16_wood_course_end[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR,
                G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (64 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
