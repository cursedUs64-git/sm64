...
const Lights1 rr_seg7_lights_07019230 =
...
const s16 flying_carpet_static_vertex_data[] = {
    //     x     z    tx    ty
    -306, 205,  0,   0,    -306, 0,   992,  0,    -306, -204, 0,   0,    -204, 205,  0,   308,  -204,
    0,    992,  308, -204, -204, 0,   308,  -102, 205,  0,    650, -102, 0,    992,  650, -102, -204,
    0,    650,  0,   205,  0,    992, 0,    0,    992,  992,  0,   -204, 0,    992,  102, 205,  0,
    650,  102,  0,   992,  650,  102, -204, 0,    650,  205,  205, 0,    308,  205,  0,   992,  308,
    205,  -204, 0,   308,  307,  205, 0,    0,    307,  0,    990, 0,    307,  -204, 0,   0,
};
