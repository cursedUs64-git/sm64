...
const MacroObject rr_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_cannon_closed, /*yaw*/ 0, /*pos*/ 5545, 3333, -2345,
                                /*bhvParam*/ 0xC0),
    MACRO_OBJECT(/*preset*/ macro_box_1up, /*yaw*/ 0, /*pos*/ -6750, 2600, -50),
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_circling_amp, /*yaw*/ 0, /*pos*/ 6500, -900, 900,
    ...
    MACRO_OBJECT_WITH_BHV_PARAM(/*preset*/ macro_circling_amp, /*yaw*/ 0, /*pos*/ -6571, 4000, -2328,
                                /*bhvParam*/ AMP_BP_ROT_RADIUS_300),
